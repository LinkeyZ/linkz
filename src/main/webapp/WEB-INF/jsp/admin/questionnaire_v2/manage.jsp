...
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT BEGINS -->
		<a href="/admin/questionnaire_v2/add" class="btn btn-primary">
		...
		<div>
			<table id="dynamic-table" class="table table-striped table-bordered table-hover">
				...
				<tbody>
				<c:forEach var="item" items="${ questionnaireList }">
					<tr>
						<td>${ item.questionnaireCode }</td>
						<td>${ item.name }</td>
						<td>
						...
						<td>
							<div class="hidden-sm hidden-xs action-buttons" id="bootbox-confirm">
								<a class="green" href="/admin/questionnaire_v2/edit?id=${item.id}">
									<i class="ace-icon fa fa-pencil bigger-130"></i>
								</a>

								<a class="red" href="/admin/questionnaire_v2/delete?id=${item.id}" 
