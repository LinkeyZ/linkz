				...
				<tbody>
					<c:forEach var="item" items="${ page }">
						<tr>
							...
							<td><fmt:formatDate value="${ item.publishDate }" pattern="yyyy年MM月dd日 HH:mm:ss"/></td>
							<td>
								<div class="hidden-sm hidden-xs action-buttons" id="bootbox-confirm">
									<a class="green" href="/admin/news/edit?id=${ item.id }">
										<i class="ace-icon fa fa-pencil bigger-130"></i>
									</a>

									<a class="red" href="/admin/news/delete?id=${ item.id }" 
