...
<body>
<form:form method="post" id="theForm" name="theForm" action="/admin/news/update" enctype="multipart/form-data">
		...
		<div class="addChannel">
			<h1>添加资讯</h1>
				<div class="aa1" style="height: auto;">
					...
					<div>
						<select name="channelid" style="width: 92%; height: 25px; padding-top: 2px; font-size: 14px;">
							...
							<c:choose>
								<c:when test="${t.name == model.channel.name}">
				...
				<div class="aa1" style="height: auto;">
					<p>主标题</p>
					<div>
						<input value="${model.title}" name="title" class="input_public" style="width: 92%;" type="text">
					</div>
				</div>
				<div class="aa1" style="height: auto;">
					<p>副标题</p>
					<div>
						<input value="${model.subtitle}" name="subtitle" class="input_public" style="width: 92%;" type="text">
					</div>
				</div>
				<div class="aa1" style="height: auto;">
					<p>作者</p>
					<div>
						<input value="${model.author}" name="author" value="Bruce" class="input_public" style="width: 92%;" type="text">
					</div>
				</div>
				<div class="aa1">
					<p>发布日期</p>
					<div class="date">
						<div class="col-wrap-4 input-text" style="position: relative;">
							...
							<input value="<fmt:formatDate value='${model.publishDate}' pattern='yyyy-MM-dd'/>" type="text" data-date-format="yyyy-mm-dd" name="publishDate"
				...
				<div class="aa1" style="height: auto;">
					<p>logo图</p>
					<input id="id_featured_image" type="text" class="vFileBrowseField" name="logo" value="${model.logo}" />
