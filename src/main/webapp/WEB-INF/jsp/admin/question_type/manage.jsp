...
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT BEGINS -->
		<a href="/admin/question_type/add" class="btn btn-primary">
					...
					<tr>
						...
						<td>
							<div class="hidden-sm hidden-xs action-buttons" id="bootbox-confirm">
								<a class="green" href="/admin/question_type/edit?id=${item.id}">
									<i class="ace-icon fa fa-pencil bigger-130"></i>
								</a>

								<a class="red" href="/admin/question_type/delete?id=${item.id}" 
