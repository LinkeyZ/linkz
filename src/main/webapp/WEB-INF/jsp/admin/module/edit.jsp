...
<div class="page-header">
	<h1>
		编辑资源模块 <small> <i class="ace-icon fa fa-angle-double-right"></i>
			overview &amp; stats
		</small>
	</h1>
</div>
...
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT BEGINS -->
		<form class="form-horizontal" id="validation-form" role="form" action="/admin/module/edit"
			method="post">
			<input type="hidden" name="id" value="${module.id}">
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right"
					for="form-field-1"> 资源模块名 </label>
				<div class="col-sm-9">
					<input value="${module.name}" name="name" type="text"
						id="form-field-1" placeholder="Name" class="col-xs-10 col-sm-5" />
				</div>
			</div>

			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right"
					for="form-field-2"> 资源地址 </label>

				<div class="col-sm-9">
					<input value="${module.url}" name="url" type="text"
						id="form-field-2" placeholder="Url" class="col-xs-10 col-sm-5" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right"
				...
				<div class="col-sm-4">
					...
					<input value="${parentName }" name="parentName" type="text"
						onclick="showMenu()" id="parentSel" placeholder="--请选择--"
						class="col-xs-10 col-sm-12" readonly="readonly" />
					<input name="parentId" id="parentId" value="${module.parentId}" type="hidden"/>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<select id="form-field-5" name="type" class="col-xs-10 col-sm-5">
						<option value="1" <c:if test="${module.type == 1 }"> selected="selected"</c:if>>导航</option>
						<option value="2" <c:if test="${module.type == 2 }"> selected="selected"</c:if>>操作</option>
					</select>
				</div>
			</div>
			<div class="form-group">
