...
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT BEGINS -->
		<form class="form-horizontal" role="form" action="/admin/role/edit" method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					...
					<input value="${role.organization.name}" name="organ" type="text"
					...
					<input name="organizationID" id="organization" value="${role.organization.id}"" type="hidden"/>
					</div>
				</div>		
			</div>
					...
					<div class="clearfix">
						<select name="role_type" class="col-xs-10 col-sm-5" 
							...
							<c:forEach var="item" items="${ roleTypeList }">
								<c:if test="${ item.id == role.roleType.id }">
