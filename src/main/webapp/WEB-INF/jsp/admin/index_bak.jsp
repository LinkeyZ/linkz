...
<c:set var="title" value="Mmednet Admin"></c:set>
<!DOCTYPE html>
<html lang="en">
	<head>
	...
	<body class="no-skin">
		<div id="navbar" class="navbar navbar-default">
			...
			<!-- navbar-container -->
			<c:import url="/WEB-INF/jsp/admin/navbar-container.jsp"></c:import>
		</div>
		...
		<div class="main-container" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive">
				...
				<!-- 菜单栏 -->
				<c:import url="/WEB-INF/jsp/admin/nav-list.jsp"></c:import>
