...
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT BEGINS -->
		<form class="form-horizontal" role="form" action="/admin/binding/orga/edit" method="post">
			<input type="hidden" name="id" value="${ organConfig.id }">
...
$(window).load(function(){
	...
	//alert('${ organConfig.roleids }');
	
	$.ajax({
		type: "POST",
		url: "ajax/getOrgaRoles?t=" + new Date().getTime(),
		data: { 
			orgaids: '${ organConfig.orgaids }',
			roleids: '${ organConfig.roleids }'
		},
		success:function(data){
			$.fn.zTree.init($("#organTree2"), setting, data);
		}
